...
- `results/tables/gate5_ensemble_contrast.csv`
- `GateD_robustness_discriminability/results/certificates/gates_summary_gateD.json`
...
- `results/certificates/gates_summary_gateE.json` — complete frozen result.
