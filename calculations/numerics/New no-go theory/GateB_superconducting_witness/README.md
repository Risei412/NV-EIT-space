...
Reuses `calculations/numerics/New no-go theory/src/core.py` (`certificate_deg_nu` — valid for
...
Outputs: `results/certificates/gates_summary_gateB.json` (with the `blind_prediction`
