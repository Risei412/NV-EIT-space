...
Reuses `calculations/numerics/No-go theorem/src/{group_iv_model, nv_reduced_kernel,
verify_nv_3E_graph_distance_PRL, moment_order_common_pipeline, liouvillian_core,
phonon_rates}`, `calculations/numerics/New no-go theory/src/core.py`, and Gate B's
...
Outputs: `results/certificates/gates_summary_gateC.json`, `results/tables/gate_c_collapse.csv`,
