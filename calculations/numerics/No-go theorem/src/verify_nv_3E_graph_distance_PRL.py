...
_RES = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                    '..', '..', '..', '..', 'results')
fig.savefig(os.path.join(_RES, "figures", "fig_nv_3E_graph_distance.png"), dpi=200)

# ----------------------------------------------------------------------------
# 6. Persist and summarize
# ----------------------------------------------------------------------------
with open(os.path.join(_RES, "certificates",
                       "results_nv_3E_graph_distance.json"), "w") as f:
