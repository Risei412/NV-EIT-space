...
SRC = os.path.join(HERE, "..", "..", "numerics", "New no-go theory", "PhaseO_observable_inheritance", "src")
PHASE_SRC = os.path.join(HERE, "..", "..", "numerics", "New no-go theory", "src")
NOGO = os.path.join(HERE, "..", "..", "numerics", "No-go theorem", "src")
ROOMT = os.path.join(HERE, "..", "..", "numerics", "New no-go theory", "RoomT", "src")
